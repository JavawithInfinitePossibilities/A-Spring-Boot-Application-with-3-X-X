...
public class StudentRESTController {
    ...
    public StudentDB getStudent(@PathVariable("id") long id) {
        LOGGER.info("Finding Students by id : " + id);
        return studentRepository.findById(id).get();
    }

    @RequestMapping(value = "/StudentByName/{name}", method = RequestMethod.GET)
    public List<StudentDB> getStudentByName(@PathVariable("name") String name) {
    ...
    public List<StudentDB> getStudentByNameAndMark(@PathVariable("name") String name,
    ...
    public StudentDB createStudent(@RequestBody StudentDB product) {
        return studentRepository.save(product);
    }

    @RequestMapping(value = "/StudentUpdate/", method = RequestMethod.PUT)
    public StudentDB updateStudent(@RequestBody StudentDB product) {
        return studentRepository.save(product);
    }
